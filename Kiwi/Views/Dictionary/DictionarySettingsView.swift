...
struct DictionarySettingsView: View {
    ...
    enum DictionarySection: String, CaseIterable {
        ...
        var description: String {
            switch self {
            case .spellings:
                return "Add words to help \(AppConfiguration.appName) recognize them properly"
            case .replacements:
    ...
    private var heroSection: some View {
        VStack(spacing: 24) {
            ...
            VStack(spacing: 8) {
                ...
                Text("Enhance \(AppConfiguration.appName)'s transcription accuracy by teaching it your vocabulary")
                    .font(.system(size: 15))
