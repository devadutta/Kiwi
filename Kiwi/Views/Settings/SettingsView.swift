...
struct SettingsView: View {
    ...
    @AppStorage("IsAudioCleanupEnabled") private var audioCleanupEnabled = false
        ...
        ScrollView {
            VStack(spacing: 24) {
                SettingsSection(
                    icon: "command.circle",
                    title: "Kiwi Shortcut",
                    subtitle: "Choose how you want to trigger Kiwi"
                ) {
                ...
                SettingsSection(
                    ...
                    subtitle: "Assign keyboard shortcuts to activate Power Modes"
                ) {
                ...
                SettingsSection(
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        Toggle("Enable automatic audio cleanup", isOn: $audioCleanupEnabled)
                            .toggleStyle(.switch)
                            .help("Automatically delete old audio files to save disk space")
            ...
            HStack(spacing: 12) {
                ...
                if showWarning {
                    ...
                    Image(systemName: "exclamationmark.triangle.fill")
                        .foregroundColor(.red)
                        .help("Permission required for Kiwi to function properly")
                }
            }
