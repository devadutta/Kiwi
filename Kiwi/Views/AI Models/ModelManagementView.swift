                    ...
                    if selectedFilter == .local {
                        HStack(spacing: 8) {
                            ...
                            InfoTip(
                                ...
                                message: "Add a custom fine-tuned whisper model to use with Kiwi. Select the downloaded .bin file.",
                                learnMoreURL: "https://tryKiwi.com/docs/custom-local-whisper-models"
                            )
