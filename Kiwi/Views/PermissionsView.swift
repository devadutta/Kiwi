            ...
            VStack(spacing: 32) {
                ...
                VStack(spacing: 24) {
                    ...
                    VStack(spacing: 8) {
                        ...
                        Text("Kiwi requires the following permissions to function properly")
                            .font(.system(size: 15))
                ...
                VStack(spacing: 16) {
                    ...
                    PermissionCard(
                        ...
                        description: "Set up a keyboard shortcut to use Kiwi anywhere",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow Kiwi to record your voice for transcription",
                    ...
                    PermissionCard(
                        ...
                        description: "Allow Kiwi to paste transcribed text directly at your cursor position",
