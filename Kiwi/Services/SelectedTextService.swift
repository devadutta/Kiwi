...
class SelectedTextService {
    ...
    private static let privatePasteboardType = NSPasteboard.PasteboardType(AppConfiguration.transientPasteboardType)

    static func fetchSelectedText() -> String? {
        // Don't check for selected text within Kiwi itself
        guard let frontmostApp = NSWorkspace.shared.frontmostApplication,
              frontmostApp.bundleIdentifier != AppConfiguration.bundleIdentifier else {
            return nil
        }
